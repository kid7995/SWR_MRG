...
class Robot {
  public:
    ...
    bool AGPConnect(QString agpIP);
    void AGPRun(const Craft &craft, bool isRotated);
    void AGPStop();
    bool IsAGPEnabled();
    ...
    bool GetEndPoint();
    bool GetAuxPoint();
    bool GetBeginOffsetPoint();
    bool GetEndOffsetPoint();
    int GetMidPoint(qint64 pressDuration);
    bool ClearPoints();
    bool ClearMidPoints();
    int DelLastMidPoint();
